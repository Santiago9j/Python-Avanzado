...
public class EmpleadoInsertar {
    ...
    public EmpleadoInsertar(int id, String identificacion, String primer_nombre, String primer_apellido, String segundo_apellido, String celular, String direccion, String fecha_nacimiento, double salario, String fecha_ingreso, int cargo, int sucursal, int nacionalidad, int eps, int tipo_documento) {
        this.id = id;
